...
export const translations = {
  en: {
    ...
    passwordRequirements: "Minimum 6 characters required",
    savePassword: "Save Password",
    passwordUpdated: "Password updated successfully!",
    passwordUpdateFailed: "Failed to update password",
    passwordMinLength: "Password must be at least 6 characters",
    passwordsDoNotMatch: "Passwords do not match",
    passwordSavedOffline: "Password Saved Offline",
    passwordWillSyncOnline: "Your password will be updated when you're back online.",
    passwordSynced: "Password Synced",
    passwordSyncedDesc: "Your password has been updated successfully.",
    emailNotifications: "Email Notifications",
    emailNotificationsDesc: "Manage your notification preferences",
    receiveEmailNotifications: "Receive Email Notifications",
    emailNotificationsHint: "Get updates about your learning progress (demo)",
    notificationsEnabled: "Email notifications enabled",
    notificationsDisabled: "Email notifications disabled",
  ...
  hi: {
    ...
    yourAccountInfo: "आपकी खाता जानकारी",
    role: "भूमिका",
    ...
    passwordRequirements: "न्यूनतम 6 अक्षर आवश्यक",
    ...
    passwordSavedOffline: "पासवर्ड ऑफ़लाइन सहेजा गया",
    passwordWillSyncOnline: "जब आप ऑनलाइन होंगे तो आपका पासवर्ड अपडेट हो जाएगा।",
    passwordSynced: "पासवर्ड सिंक हो गया",
    passwordSyncedDesc: "आपका पासवर्ड सफलतापूर्वक अपडेट हो गया।",
    emailNotifications: "ईमेल सूचनाएं",
    emailNotificationsDesc: "अपनी सूचना प्राथमिकताएं प्रबंधित करें",
    receiveEmailNotifications: "ईमेल सूचनाएं प्राप्त करें",
    emailNotificationsHint: "अपनी शिक्षा प्रगति के बारे में अपडेट प्राप्त करें (डेमो)",
    notificationsEnabled: "ईमेल सूचनाएं सक्षम",
    notificationsDisabled: "ईमेल सूचनाएं अक्षम",
